...
According to @wikigentoo, in 2018 the Gentoo GitHub repository was hacked because an attacker was able to deduce the password.
...
The Free Software Foundation justifies not including Gentoo Linux on their list of free Linux distributions with the following short statement: "Gentoo includes installation recipes for a number of nonfree programs in its primary package system" [@gnu-explaining].
...
All of the applications and tools recommended and endorsed by Gentoo wiki are free [@gentoo-recommended-applications; @gentoo-recommended-tools].
...
The GNU FSDG states "The system should have no repositories for nonfree software and no specific recipes for installation of particular nonfree programs [@gnu-fsdg]."
