...
Science shows that life undeniably begins at conception [@when-human-life-begins].
...
```{r dr-levatino-testimony}
shortcode("youtube", "A16gzm9eaa8")
```
...
```{r kim-kardashian-death-penalty}
shortcode("twitter", user = "KimKardashian", id = "1333114655980589057")
```
```{r kim-kardashian-death-penalty-victims}
shortcode("twitter", user = "KimKardashian", id = "1333114657737945090")
```
