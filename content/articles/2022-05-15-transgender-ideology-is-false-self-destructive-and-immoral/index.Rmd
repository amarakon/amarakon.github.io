...
Gender identity was invented by a sexologist named John Money [@wikijohn-money].
...
```{r michael-knowles-helena-kerschner}
shortcode("youtube", "5HbPzJy9gkY")
```

# Immoral

A white person named Oli London wants penis reduction surgery to be "100% Korean" [@white-korean].
...
According to @mental-disorders, "Those who had received a diagnosis of gender identity disorder or transsexualism and were seeking hormone treatment and/or surgery" is only .005 to .014% for males and .002 to .003% for females.
